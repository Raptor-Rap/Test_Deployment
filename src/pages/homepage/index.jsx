                ...
                return (
                  ...
                  >
                    ...
                    <div className="star mb-2 px-3">
                      <i className={destination.star1}></i>
                      <i className={destination.star2}></i>
                      <i className={destination.star3}></i>
                      <i className={destination.star4}></i>
                      <i className={destination.star5}></i>
                    </div>
